...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.quote = makeButton("wmd-quote-button", "Blockquote - Ctrl+Q", "icon-quote-right", bindCommand("doBlockquote"), group2);
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "icon-beaker", bindCommand("doCode"), group2);
            ...
            buttons.heading = makeButton("wmd-heading-button", "Heading - Ctrl+H", "icon-pencil", bindCommand("doHeading"), group3);
            buttons.hr = makeButton("wmd-hr-button", "Horizontal Rule - Ctrl+R", "icon-list-alt", bindCommand("doHorizontalRule"), group3);
